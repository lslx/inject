...
int main(int argc, char** argv) {    
    ...
    if (argc >= 2) {
        ...
        // const char* processname = "com.pocketmon.baidu";
        const char* processname = "com.nanfangjijin.app";  
        target_pid = find_pid_of(processname);  
    }
    printf("target_pid = %d\n", target_pid);

    //注释掉了调用hook_entry, 通过init函数调用hook
    char* param = "I'm parameter!";
    char* injected_lib = "/data/local/tmp/libgkutil.so";
